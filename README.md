...
|SpringBoot开发web项目的基本注意事项|[README-SpringBootWeb.md](https://github.com/MajorTooooom/SpringBoot/blob/master/README-SpringBootWeb.md)|1)静态资源问题;<br/>2)首页如何放置;<br/>3)SpringMVC配置原理;<br/>4)||
